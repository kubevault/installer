...
func TestParseImage(t *testing.T) {
	tests := []struct {
		...
		{
			name:    "kubevault/vaultserver:v1.2.3",
			arg:     "kubevault/vaultserver:v1.2.3",
			wantReg: "kubevault",
			wantBin: "vaultserver",
			wantTag: "v1.2.3",
		},
		{
			name:    "vaultserver:v1.2.3",
			arg:     "vaultserver:v1.2.3",
			wantReg: "",
			wantBin: "vaultserver",
			wantTag: "v1.2.3",
		},
		{
			name:    "kubevault/vaultserver",
			arg:     "kubevault/vaultserver",
			wantReg: "kubevault",
			wantBin: "vaultserver",
			wantTag: "",
		},
