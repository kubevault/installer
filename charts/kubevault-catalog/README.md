...
$ helm repo update
$ helm search repo appscode/kubevault-catalog --version=v2022.11.30
$ helm upgrade -i kubevault-catalog appscode/kubevault-catalog -n kubevault --create-namespace --version=v2022.11.30
```
...
```bash
$ helm upgrade -i kubevault-catalog appscode/kubevault-catalog -n kubevault --create-namespace --version=v2022.11.30 --set image.registry=kubevault
```
...
```bash
$ helm upgrade -i kubevault-catalog appscode/kubevault-catalog -n kubevault --create-namespace --version=v2022.11.30 --values values.yaml
```
