...
$ helm repo update
$ helm search repo appscode/kubevault-catalog --version=v2026.2.27
$ helm upgrade -i kubevault-catalog appscode/kubevault-catalog -n kubevault --create-namespace --version=v2026.2.27
```
...
```bash
$ helm upgrade -i kubevault-catalog appscode/kubevault-catalog -n kubevault --create-namespace --version=v2026.2.27 --set proxies.ghcr=ghcr.io
```
...
```bash
$ helm upgrade -i kubevault-catalog appscode/kubevault-catalog -n kubevault --create-namespace --version=v2026.2.27 --values values.yaml
```
