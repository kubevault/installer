...
$ helm repo update
$ helm search repo appscode/kubevault-catalog --version=v2026.8.7
$ helm upgrade -i kubevault-catalog appscode/kubevault-catalog -n kubevault --create-namespace --version=v2026.8.7
```
...
```bash
$ helm upgrade -i kubevault-catalog appscode/kubevault-catalog -n kubevault --create-namespace --version=v2026.8.7 --set proxies.dockerHub=docker.io
```
...
```bash
$ helm upgrade -i kubevault-catalog appscode/kubevault-catalog -n kubevault --create-namespace --version=v2026.8.7 --values values.yaml
```
