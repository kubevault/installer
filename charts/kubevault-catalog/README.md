...
$ helm repo update
$ helm search repo appscode/kubevault-catalog --version=v2025.5.30
$ helm upgrade -i kubevault-catalog appscode/kubevault-catalog -n kubevault --create-namespace --version=v2025.5.30
```
...
```bash
$ helm upgrade -i kubevault-catalog appscode/kubevault-catalog -n kubevault --create-namespace --version=v2025.5.30 --set proxies.ghcr=ghcr.io
```
...
```bash
$ helm upgrade -i kubevault-catalog appscode/kubevault-catalog -n kubevault --create-namespace --version=v2025.5.30 --values values.yaml
```
