...
$ helm repo update
$ helm search repo appscode/kubevault-catalog --version=v2022.09.05-rc.0
$ helm upgrade -i kubevault-catalog appscode/kubevault-catalog -n kubevault --create-namespace --version=v2022.09.05-rc.0
```
...
```bash
$ helm upgrade -i kubevault-catalog appscode/kubevault-catalog -n kubevault --create-namespace --version=v2022.09.05-rc.0 --set image.registry=kubevault
```
...
```bash
$ helm upgrade -i kubevault-catalog appscode/kubevault-catalog -n kubevault --create-namespace --version=v2022.09.05-rc.0 --values values.yaml
```
