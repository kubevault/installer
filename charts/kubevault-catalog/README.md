...
$ helm repo update
$ helm search repo appscode/kubevault-catalog --version=v2026.5.18-rc.1
$ helm upgrade -i kubevault-catalog appscode/kubevault-catalog -n kubevault --create-namespace --version=v2026.5.18-rc.1
```
...
```bash
$ helm upgrade -i kubevault-catalog appscode/kubevault-catalog -n kubevault --create-namespace --version=v2026.5.18-rc.1 --values values.yaml
```
