...
$ helm repo update
$ helm search repo appscode/kubevault-catalog --version=v2026.5.14-rc.0
$ helm upgrade -i kubevault-catalog appscode/kubevault-catalog -n kubevault --create-namespace --version=v2026.5.14-rc.0
```
...
```bash
$ helm upgrade -i kubevault-catalog appscode/kubevault-catalog -n kubevault --create-namespace --version=v2026.5.14-rc.0 --set proxies.ghcr=ghcr.io
```
...
```bash
$ helm upgrade -i kubevault-catalog appscode/kubevault-catalog -n kubevault --create-namespace --version=v2026.5.14-rc.0 --values values.yaml
```
