...
$ helm repo update
$ helm search repo appscode/kubevault --version=v2024.1.28-rc.1
$ helm upgrade -i kubevault appscode/kubevault -n kubevault --create-namespace --version=v2024.1.28-rc.1
```
...
```bash
$ helm upgrade -i kubevault appscode/kubevault -n kubevault --create-namespace --version=v2024.1.28-rc.1 --set global.registry=kubevault
```
...
```bash
$ helm upgrade -i kubevault appscode/kubevault -n kubevault --create-namespace --version=v2024.1.28-rc.1 --values values.yaml
```
