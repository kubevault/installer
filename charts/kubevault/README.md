...
$ helm repo update
$ helm search repo appscode/kubevault --version=v2024.3.12
$ helm upgrade -i kubevault appscode/kubevault -n kubevault --create-namespace --version=v2024.3.12
```
...
```bash
$ helm upgrade -i kubevault appscode/kubevault -n kubevault --create-namespace --version=v2024.3.12 --set global.registry=kubevault
```
...
```bash
$ helm upgrade -i kubevault appscode/kubevault -n kubevault --create-namespace --version=v2024.3.12 --values values.yaml
```
