...
$ helm repo update
$ helm search repo appscode/kubevault-opscenter --version=v2024.1.28-rc.1
$ helm upgrade -i kubevault-opscenter appscode/kubevault-opscenter -n kubevault --create-namespace --version=v2024.1.28-rc.1
```
...
```bash
$ helm upgrade -i kubevault-opscenter appscode/kubevault-opscenter -n kubevault --create-namespace --version=v2024.1.28-rc.1 --set global.registryFQDN=ghcr.io
```
...
```bash
$ helm upgrade -i kubevault-opscenter appscode/kubevault-opscenter -n kubevault --create-namespace --version=v2024.1.28-rc.1 --values values.yaml
```
