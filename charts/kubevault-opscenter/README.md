...
$ helm repo update
$ helm search repo appscode/kubevault-opscenter --version=v2024.3.12
$ helm upgrade -i kubevault-opscenter appscode/kubevault-opscenter -n kubevault --create-namespace --version=v2024.3.12
```
...
```bash
$ helm upgrade -i kubevault-opscenter appscode/kubevault-opscenter -n kubevault --create-namespace --version=v2024.3.12 --set global.registryFQDN=ghcr.io
```
...
```bash
$ helm upgrade -i kubevault-opscenter appscode/kubevault-opscenter -n kubevault --create-namespace --version=v2024.3.12 --values values.yaml
```
