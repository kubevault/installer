...
$ helm repo update
$ helm search repo appscode/kubevault-opscenter --version=v2026.5.14-rc.0
$ helm upgrade -i kubevault-opscenter appscode/kubevault-opscenter -n kubevault --create-namespace --version=v2026.5.14-rc.0
```
...
```bash
$ helm upgrade -i kubevault-opscenter appscode/kubevault-opscenter -n kubevault --create-namespace --version=v2026.5.14-rc.0 --set global.registryFQDN=ghcr.io
```
...
```bash
$ helm upgrade -i kubevault-opscenter appscode/kubevault-opscenter -n kubevault --create-namespace --version=v2026.5.14-rc.0 --values values.yaml
```
