...
$ helm repo update
$ helm search repo appscode/kubevault-grafana-dashboards --version=v2026.2.27
$ helm upgrade -i kubevault-grafana-dashboards appscode/kubevault-grafana-dashboards -n kubeops --create-namespace --version=v2026.2.27
```
...
```bash
$ helm upgrade -i kubevault-grafana-dashboards appscode/kubevault-grafana-dashboards -n kubeops --create-namespace --version=v2026.2.27 --set resources=["vaultserver"]
```
...
```bash
$ helm upgrade -i kubevault-grafana-dashboards appscode/kubevault-grafana-dashboards -n kubeops --create-namespace --version=v2026.2.27 --values values.yaml
```
