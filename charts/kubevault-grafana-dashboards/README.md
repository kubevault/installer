...
$ helm repo update
$ helm search repo appscode/kubevault-grafana-dashboards --version=v2023.03.03
$ helm upgrade -i kubevault-grafana-dashboards appscode/kubevault-grafana-dashboards -n kubeops --create-namespace --version=v2023.03.03
```
...
```bash
$ helm upgrade -i kubevault-grafana-dashboards appscode/kubevault-grafana-dashboards -n kubeops --create-namespace --version=v2023.03.03 --set resources=["vaultserver"]
```
...
```bash
$ helm upgrade -i kubevault-grafana-dashboards appscode/kubevault-grafana-dashboards -n kubeops --create-namespace --version=v2023.03.03 --values values.yaml
```
