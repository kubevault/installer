...
$ helm repo update
$ helm search repo appscode/kubevault-grafana-dashboards --version=v2025.2.10
$ helm upgrade -i kubevault-grafana-dashboards appscode/kubevault-grafana-dashboards -n kubeops --create-namespace --version=v2025.2.10
```
...
```bash
$ helm upgrade -i kubevault-grafana-dashboards appscode/kubevault-grafana-dashboards -n kubeops --create-namespace --version=v2025.2.10 --set resources=["vaultserver"]
```
...
```bash
$ helm upgrade -i kubevault-grafana-dashboards appscode/kubevault-grafana-dashboards -n kubeops --create-namespace --version=v2025.2.10 --values values.yaml
```
