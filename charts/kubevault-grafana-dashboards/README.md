...
$ helm repo update
$ helm search repo appscode/kubevault-grafana-dashboards --version=v2025.5.30
$ helm upgrade -i kubevault-grafana-dashboards appscode/kubevault-grafana-dashboards -n kubeops --create-namespace --version=v2025.5.30
```
...
```bash
$ helm upgrade -i kubevault-grafana-dashboards appscode/kubevault-grafana-dashboards -n kubeops --create-namespace --version=v2025.5.30 --set resources=["vaultserver"]
```
...
```bash
$ helm upgrade -i kubevault-grafana-dashboards appscode/kubevault-grafana-dashboards -n kubeops --create-namespace --version=v2025.5.30 --values values.yaml
```
