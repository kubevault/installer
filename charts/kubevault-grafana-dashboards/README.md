...
$ helm repo update
$ helm search repo appscode/kubevault-grafana-dashboards --version=v2024.1.28-rc.1
$ helm upgrade -i kubevault-grafana-dashboards appscode/kubevault-grafana-dashboards -n kubeops --create-namespace --version=v2024.1.28-rc.1
```
...
```bash
$ helm upgrade -i kubevault-grafana-dashboards appscode/kubevault-grafana-dashboards -n kubeops --create-namespace --version=v2024.1.28-rc.1 --set resources=["vaultserver"]
```
...
```bash
$ helm upgrade -i kubevault-grafana-dashboards appscode/kubevault-grafana-dashboards -n kubeops --create-namespace --version=v2024.1.28-rc.1 --values values.yaml
```
