...
$ helm repo update
$ helm search repo appscode/kubevault-crds --version=v2024.3.12
$ helm upgrade -i kubevault-crds appscode/kubevault-crds -n kubevault --create-namespace --version=v2024.3.12
```
