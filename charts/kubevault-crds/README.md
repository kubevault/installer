...
$ helm repo update
$ helm search repo appscode/kubevault-crds --version=v2026.8.7
$ helm upgrade -i kubevault-crds appscode/kubevault-crds -n kubevault --create-namespace --version=v2026.8.7
```
