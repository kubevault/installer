...
$ helm repo update
$ helm search repo appscode/kubevault-crds --version=v2022.11.30
$ helm upgrade -i kubevault-crds appscode/kubevault-crds -n kubevault --create-namespace --version=v2022.11.30
```
