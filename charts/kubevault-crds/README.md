...
$ helm repo update
$ helm search repo appscode/kubevault-crds --version=v2026.5.18-rc.1
$ helm upgrade -i kubevault-crds appscode/kubevault-crds -n kubevault --create-namespace --version=v2026.5.18-rc.1
```
