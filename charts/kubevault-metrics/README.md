...
$ helm repo update
$ helm search repo appscode/kubevault-metrics --version=v2025.5.26
$ helm upgrade -i kubevault-metrics appscode/kubevault-metrics -n kubevault --create-namespace --version=v2025.5.26
```
