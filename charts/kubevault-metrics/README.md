...
$ helm repo update
$ helm search repo appscode/kubevault-metrics --version=v2023.05.05
$ helm upgrade -i kubevault-metrics appscode/kubevault-metrics -n kubevault --create-namespace --version=v2023.05.05
```
