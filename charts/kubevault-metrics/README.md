...
$ helm repo update
$ helm search repo appscode/kubevault-metrics --version=v2026.5.18-rc.1
$ helm upgrade -i kubevault-metrics appscode/kubevault-metrics -n kubevault --create-namespace --version=v2026.5.18-rc.1
```
