...
$ helm repo update
$ helm search repo appscode/kubevault-metrics --version=v2022.09.05-rc.0
$ helm upgrade -i kubevault-metrics appscode/kubevault-metrics -n kube-system --create-namespace --version=v2022.09.05-rc.0
```
