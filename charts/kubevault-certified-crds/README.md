# kubevault-certified-crds

[kubevault-certified-crds](https://github.com/kubevault) - HashiCorp Vault operator for Kubernetes
...
$ helm repo update
$ helm search repo appscode/kubevault-certified-crds --version=v2025.11.21
$ helm upgrade -i kubevault-certified-crds appscode/kubevault-certified-crds -n kubevault --create-namespace --version=v2025.11.21
```
...
To install/upgrade the chart with the release name `kubevault-certified-crds`:
...
To uninstall the `kubevault-certified-crds`:

```bash
$ helm uninstall kubevault-certified-crds -n kubevault
```
...
The following table lists the configurable parameters of the `kubevault-certified-crds` chart and their default values.
...
```bash
$ helm upgrade -i kubevault-certified-crds appscode/kubevault-certified-crds -n kubevault --create-namespace --version=v2025.11.21 --set global.registry=kubevault
```
...
```bash
$ helm upgrade -i kubevault-certified-crds appscode/kubevault-certified-crds -n kubevault --create-namespace --version=v2025.11.21 --values values.yaml
```
