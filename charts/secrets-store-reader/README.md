...
$ helm repo update
$ helm search repo appscode/secrets-store-reader --version=v2022.06.16
$ helm upgrade -i secrets-store-reader appscode/secrets-store-reader -n kubevault --create-namespace --version=v2022.06.16
```
...
```bash
$ helm upgrade -i secrets-store-reader appscode/secrets-store-reader -n kubevault --create-namespace --version=v2022.06.16 --set replicaCount=1
```
...
```bash
$ helm upgrade -i secrets-store-reader appscode/secrets-store-reader -n kubevault --create-namespace --version=v2022.06.16 --values values.yaml
```
