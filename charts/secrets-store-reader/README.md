...
$ helm repo update
$ helm search repo appscode/secrets-store-reader --version=v2024.1.28-rc.1
$ helm upgrade -i secrets-store-reader appscode/secrets-store-reader -n kubevault --create-namespace --version=v2024.1.28-rc.1
```
...
```bash
$ helm upgrade -i secrets-store-reader appscode/secrets-store-reader -n kubevault --create-namespace --version=v2024.1.28-rc.1 --set replicaCount=1
```
...
```bash
$ helm upgrade -i secrets-store-reader appscode/secrets-store-reader -n kubevault --create-namespace --version=v2024.1.28-rc.1 --values values.yaml
```
