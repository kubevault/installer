...
$ helm repo update
$ helm search repo appscode/secrets-store-reader --version=v2022.04.04
$ helm upgrade -i secrets-store-reader appscode/secrets-store-reader -n kubevault --create-namespace --version=v2022.04.04
```
...
```bash
$ helm upgrade -i secrets-store-reader appscode/secrets-store-reader -n kubevault --create-namespace --version=v2022.04.04 --set replicaCount=1
```
...
```bash
$ helm upgrade -i secrets-store-reader appscode/secrets-store-reader -n kubevault --create-namespace --version=v2022.04.04 --values values.yaml
```
