...
$ helm repo update
$ helm search repo appscode/secrets-store-reader --version=v2024.9.30
$ helm upgrade -i secrets-store-reader appscode/secrets-store-reader -n kubevault --create-namespace --version=v2024.9.30
```
...
```bash
$ helm upgrade -i secrets-store-reader appscode/secrets-store-reader -n kubevault --create-namespace --version=v2024.9.30 --set replicaCount=1
```
...
```bash
$ helm upgrade -i secrets-store-reader appscode/secrets-store-reader -n kubevault --create-namespace --version=v2024.9.30 --values values.yaml
```
