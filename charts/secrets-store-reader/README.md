# Secrets Store Reader api server
...
$ helm repo update
$ helm search repo appscode/secrets-store-reader --version=v2022.09.05-rc.0
$ helm upgrade -i secrets-store-reader appscode/secrets-store-reader -n kubevault --create-namespace --version=v2022.09.05-rc.0
```
...
```bash
$ helm upgrade -i secrets-store-reader appscode/secrets-store-reader -n kubevault --create-namespace --version=v2022.09.05-rc.0 --set replicaCount=1
```
...
```bash
$ helm upgrade -i secrets-store-reader appscode/secrets-store-reader -n kubevault --create-namespace --version=v2022.09.05-rc.0 --values values.yaml
```
