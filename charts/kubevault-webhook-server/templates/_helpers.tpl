...
*/}}
{{- define "kubevault-webhook-server.name" -}}
...
*/}}
{{- define "kubevault-webhook-server.fullname" -}}
...
*/}}
{{- define "kubevault-webhook-server.chart" -}}
...
Common labels
*/}}
{{- define "kubevault-webhook-server.labels" -}}
helm.sh/chart: {{ include "kubevault-webhook-server.chart" . }}
{{ include "kubevault-webhook-server.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "kubevault-webhook-server.selectorLabels" -}}
app.kubernetes.io/name: {{ include "kubevault-webhook-server.name" . }}
...
*/}}
{{- define "kubevault-webhook-server.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "kubevault-webhook-server.fullname" .) .Values.serviceAccount.name }}
{{- else }}
...
{{- default (printf "%s-license" (include "kubevault-webhook-server.fullname" .)) .Values.licenseSecretName }}
{{- end }}
