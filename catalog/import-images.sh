...
$CMD push --allow-nondistributable-artifacts --insecure images/appscode-images-vault-1.13.3.tar $IMAGE_REGISTRY/appscode-images/vault:1.13.3
$CMD push --allow-nondistributable-artifacts --insecure images/appscode-images-vault-1.14.10.tar $IMAGE_REGISTRY/appscode-images/vault:1.14.10
$CMD push --allow-nondistributable-artifacts --insecure images/appscode-images-vault-1.15.6.tar $IMAGE_REGISTRY/appscode-images/vault:1.15.6
...
$CMD push --allow-nondistributable-artifacts --insecure images/kubevault-vault-operator-v0.24.0-rc.0.tar $IMAGE_REGISTRY/kubevault/vault-operator:v0.24.0-rc.0
$CMD push --allow-nondistributable-artifacts --insecure images/kubevault-vault-unsealer-v0.24.0-rc.0.tar $IMAGE_REGISTRY/kubevault/vault-unsealer:v0.24.0-rc.0
