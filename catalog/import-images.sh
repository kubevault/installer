...
$CMD push --allow-nondistributable-artifacts --insecure images/openbao-openbao-2.6.1.tar $IMAGE_REGISTRY/openbao/openbao:2.6.1
...
$CMD push --allow-nondistributable-artifacts --insecure images/kubevault-kubevault-crd-manager-v0.25.0.tar $IMAGE_REGISTRY/kubevault/kubevault-crd-manager:v0.25.0
