...
$CMD push --allow-nondistributable-artifacts --insecure images/kubevault-vault-operator-v0.24.0.tar $IMAGE_REGISTRY/kubevault/vault-operator:v0.24.0
$CMD push --allow-nondistributable-artifacts --insecure images/kubevault-vault-unsealer-v0.24.0.tar $IMAGE_REGISTRY/kubevault/vault-unsealer:v0.24.0
