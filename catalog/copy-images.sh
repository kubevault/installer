...
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubevault/vault-operator:v0.24.0-rc.0 $IMAGE_REGISTRY/kubevault/vault-operator:v0.24.0-rc.0
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubevault/vault-unsealer:v0.24.0-rc.0 $IMAGE_REGISTRY/kubevault/vault-unsealer:v0.24.0-rc.0
