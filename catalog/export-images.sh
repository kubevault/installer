...
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubevault/vault-operator:v0.20.0 images/kubevault-vault-operator-v0.20.0.tar
$CMD pull --allow-nondistributable-artifacts --insecure kubevault/vault-unsealer:v0.20.0 images/kubevault-vault-unsealer-v0.20.0.tar
